...
public class DataBaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        veterinarioRepository.save(
                new Veterinario("100118798", "Vet. Andrés", "neurocirujano", 45, "12345", "andres@p.com"));
        veterinarioRepository.save(
                new Veterinario("100118799", "Vet. Gabriela", "cirujana", 30, "12345", "gabriela@p.com"));
        veterinarioRepository.save(
        ...
        veterinarioRepository.save(
                new Veterinario("100118803", "Vet. Carolina", "pediatra", 33, "12345", "carolina@p.com"));
        veterinarioRepository.save(
        ...
        veterinarioRepository.save(
                new Veterinario("100118806", "Vet. Mauricio", "neurocirujano", 36, "12345", "mauricio@p.com"));
        veterinarioRepository.save(
                new Veterinario("100118807", "Vet. Valeria", "oftalmóloga", 31, "12345", "valeria@p.com"));
        veterinarioRepository.save(
                new Veterinario("100118808", "Vet. Alejandro", "cardiólogo", 44, "12345", "alejandro@p.com"));
        veterinarioRepository.save(
                new Veterinario("100118809", "Vet. Patricia", "dermatóloga", 38, "12345", "patricia@p.com"));
        ...
        new Medicamento("Ibuprofeno", 5.0f, 10.0f, 100, 10),  // Aquí agregamos las unidadesVendidas
    ...
    private void importarMedicamentosDesdeExcel() {
        ...
        try (InputStream fis = new ClassPathResource("MEDICAMENTOS_VETERINARIA.xlsx").getInputStream();
            ...
            for (int rowIndex = 1; rowIndex <= sheet.getLastRowNum(); rowIndex++) { // Inicia desde 1 para saltar el encabezado
                ...
                if (row != null) {
                    ...
                    medicamento.setUnidadesVendidas(unidadesVendidas); // Seteamos las unidades vendidas
